 ...
 * entity or record without leaving the grid, with related workflows across domains. Consolidates the
 * three drawer chromes (steward drawer / master record drawer / settlement case pane).
 */
            ...
            <Stack spacing={0.5} sx={{ mt: 1 }}>
              {related.map((r) => (
                <Button
                  ...
                  sx={{ justifyContent: 'space-between', textAlign: 'left', px: 1.25, color: 'text.primary', '& .MuiButton-endIcon': { color: 'text.disabled' } }}
                >
                  <Box>
