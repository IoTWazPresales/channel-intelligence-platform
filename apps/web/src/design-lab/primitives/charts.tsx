...
/**
 * Shared Recharts primitives with theme-bound axes/tooltips. Replace the hand-built <div> bars in
 * Lineup/Settlement/Stock and give every surface the same chart grammar.
 */
