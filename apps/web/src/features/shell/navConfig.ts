  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Feed proposals', href: '/listing-capture?tab=proposals', roles: ALL, what: 'Listing ids seen in retailer sell-through feeds, proposed for the registry; steward confirms.' },
      {
        ...
        roles: ALL,
        status: 'partial',
        what: 'Our SKU ↔ competitor SKU with stored score, explanation and approval. Workflow works; candidate scoring is not yet wired. Score panel shows the production score, not the lab fixture blend.',
      },
      {
        ...
        roles: ALL,
        status: 'substrate',
        what: 'Observed competitor prices (fact_competitor_price). Table and list exist; no import template.',
      },
      { label: 'Competitor listings', href: '/competition?tab=competitor-listings', roles: ALL, status: 'planned', what: 'Monitor competitor product listings alongside ours (BACKLOG §9.9).' },
      { label: 'Listing quality / SEO', href: '/listing-capture?tab=quality', roles: ALL, status: 'planned', what: 'Content, specification and search-quality checks on listings (roadmap P5).' },
    ],
  },
  {
    id: 'data',
