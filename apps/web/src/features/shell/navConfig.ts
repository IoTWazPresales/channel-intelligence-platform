...
export const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Report inbox', href: '/inbox', roles: ALL },
    ],
  },
  {
    ...
    items: [
      { label: 'Stock', href: '/stock', roles: ALL },
      { label: 'Channel Operations', href: '/stock?lens=movement', roles: ALL },
      { label: 'Sell-Through', href: '/stock?lens=movement', roles: ALL },
      { label: 'CST channel intelligence', href: '/channel-intelligence', roles: ALL },
      { label: 'Listing Capture', href: '/listing-capture', roles: ALL },
      { label: 'Inbound shipments', href: '/stock?lens=inbound', roles: ALL },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Plan vs Executed', href: '/stock?lens=execution', roles: PLANNER_PLUS },
    ],
  },
  {
    id: 'master-data',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'SQL viewer', href: '/admin/sql-viewer', roles: ADMIN_ONLY },
