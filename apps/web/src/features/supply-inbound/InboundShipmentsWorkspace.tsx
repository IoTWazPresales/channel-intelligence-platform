...
/**
 * Inbound shipments workspace. Lives in features/ because Next's generated page types forbid a page
 * module from exporting anything but the page contract (the old `export function` in
 * app/(app)/shipping/page.tsx surfaced as TS2344 in .next/types after `next build`). `/shipping` and
 * `/supply/shipments` both render it; the shipping helper modules stay beside the route.
 */
