"""Dry-run Unit 4 cross-distributor mis-assignment preview for a DSI job.

Usage::

  node scripts/run-api-python.cjs scripts/preview_dsi_cross_distributor_misassignments.py --job-id 43
"""
...
from app.services.imports.dsi_distributor_receipt_disambiguation import (
    ...
    preview_cross_distributor_misassignments,
)
...
def main() -> int:
    ...
    with SessionLocal() as db:
        ...
        out = preview_cross_distributor_misassignments(
            db,
