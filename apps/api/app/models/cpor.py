...
class CporCase(Base, TimestampMixin):
    ...
    fx_mode: Mapped[str | None] = mapped_column(String(16), nullable=True)
    fx_declared_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    fx_declared_by: Mapped[str | None] = mapped_column(String(128), nullable=True)
    fx_proposed_rate: Mapped[float | None] = mapped_column(Numeric(18, 6), nullable=True)
    fx_proposed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    fx_proposed_by: Mapped[str | None] = mapped_column(String(128), nullable=True)
    fx_proposed_source: Mapped[str | None] = mapped_column(String(64), nullable=True)
