"""Background shipment resolution-plan compute (read-only plan generation off the HTTP path)."""
...
def run_shipment_resolution_plan_compute_sync(
    ...
    *,
    ...
    with SessionLocal() as db:
        try:
            out = build_shipment_resolution_plan_sync(db, job_id, candidate_ids=candidate_ids)
