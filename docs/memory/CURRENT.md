...
**Last updated:** 2026-09-15 (N-0027 implementer validate; GOV-008 not recorded)

**Branch:** `feat/ns-2-brief-nav-collapse`

**Last content pin:** `4eb8bee` (N-0027 product). Last ledger pin: `be30280` (programme snapshot **678**). Last evidence pin: `f816c75`. Last views pin: `43de26c`. Run `NS15_STEWARD_QUEUE_20260915` / actor `gov-001`.
...
- **Programme:** PRG-20260831T145514. **N-0018–N-0024 complete.** **N-0025** `in_progress` / `validate`; GOV-008 **VERIFIED_WITH_LIMITATIONS** — not completed. **N-0026** `in_progress` / `validate`; lease released; independent GOV-008 not recorded. **N-0027** `in_progress` / `validate`; lease released; independent GOV-008 not recorded. Do not reopen N-0013. D-0002 remains open.
...
**Next:** Node B — Start work surface and Lineup cases (new node / same run `NS15_STEWARD_QUEUE_20260915` or a dedicated run). Do not reuse `NS14_PROMO_PLAN_20260914` or `GOV008_N0025_20260914`. Do not run GOV-008 on these nodes. Do not remediate N-0025. Do not re-review N-0027.
...
**Deferred:** BACKLOG-174–180. BACKLOG-181 token port done; IA settled D-0010 Option A. BACKLOG-182 Payments same-URL leftover. BACKLOG-183–186 N-0026 UNCOVERED. BACKLOG-187 replay unresolved facts after catalogue-gap apply. BACKLOG-188 non-candidate steward failure types. BACKLOG-173. Budget ledger writer not chartered. Leftover `/market` stub. Stores master grid UNCOVERED. Cross-job steward accept/reject until Design Language v2. Pin-as-widget on Overview UNCOVERED. `/dashboard` legacy UNCOVERED.
