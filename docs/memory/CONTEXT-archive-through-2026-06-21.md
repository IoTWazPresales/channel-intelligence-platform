> **FROZEN ARCHIVE** — captured 2026-06-21. Do not edit. Current state:
> [`CURRENT.md`](CURRENT.md) · Index: [`MEMORY_PALACE.md`](MEMORY_PALACE.md)

# Channel Intelligence Platform — Current Context (archive)
...
- **Ops:** **`pnpm dev:worker`** includes `--beat` locally; Docker uses separate **`beat`** service. Does not replace user cancel; does not touch `idle_in_transaction` timeouts.
...
- **Unit 4:** Not applied — misassign preview (job **#43**): **4,220** candidate rows / **198** scopes; receipt re-resolution would change **120** rows (**T1** only); **4,100** still unresolved without steward. **STOP** before writes.
