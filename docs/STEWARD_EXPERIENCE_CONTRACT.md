...
- **Unit E1** — CST import steward (suggestions + resolve + UI on Import Centre); **VERIFY PASS** 2026-08-02 (docs/memory/UNIT_E_VERIFY_CLOSEOUT_2026-08-02.md)
- **Unit E2** — CST resolution-plan + async (shipped 2026-07-27; **VERIFY PASS** with E1 2026-08-02)
