---
name: naming-information-architecture-reviewer
description: Use this specialist when naming, vocabulary or information architecture may mislead users/engineers. It owns
  challenge vocabulary, labels and conceptual structure.
metadata:
  eif_id: CR-005
...
# Naming & Information Architecture Reviewer (CR-005)

## When to use
- naming, vocabulary or information architecture may mislead users/engineers
- concept boundaries are hard to distinguish
- a proposed name may encode a wrong abstraction
