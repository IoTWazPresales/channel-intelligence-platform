---
name: knowledge-documentation-steward
description: Use this specialist when canonical project documents conflict, drift or need verified updates. It owns reconcile
...
# Knowledge & Documentation Steward (GOV-005)

## When to use
- canonical project documents conflict, drift or need verified updates
- a handoff must be promoted into durable project knowledge
- documentation provenance, staleness or ownership is unclear
