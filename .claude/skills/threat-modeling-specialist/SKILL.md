...
description: Use this specialist when assets, actors, abuse cases or trust boundaries need explicit threat modeling. It owns
  assets, actors, abuse cases, trust boundaries and mitigations.
metadata:
  eif_id: SR-002
...
# Threat Modeling Specialist (SR-002)

## When to use
- assets, actors, abuse cases or trust boundaries need explicit threat modeling
- a material feature introduces new data/control flow across trust boundaries
- security mitigations need prioritization from plausible threats
