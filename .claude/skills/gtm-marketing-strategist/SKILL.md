---
name: gtm-marketing-strategist
description: Use this specialist when positioning, messaging, launch or channel strategy is needed. It owns positioning, messaging,
  channels and launch strategy.
metadata:
  eif_id: PB-010
...
# GTM & Marketing Strategist (PB-010)

## When to use
- positioning, messaging, launch or channel strategy is needed
- product capability must be translated into market-facing narrative
- GTM hypotheses or campaign/launch dependencies need analysis
