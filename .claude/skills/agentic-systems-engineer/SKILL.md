...
description: Use this specialist when the product uses agents, tools, memory or multi-step model orchestration. It owns tools,
  agents, memory, orchestration and guardrails.
metadata:
  eif_id: DA-007
...
# Agentic Systems Engineer (DA-007)

## When to use
- the product uses agents, tools, memory or multi-step model orchestration
- agent authority, tool contracts, memory or guardrails need engineering
- an autonomous AI workflow needs failure-mode and evaluation design
