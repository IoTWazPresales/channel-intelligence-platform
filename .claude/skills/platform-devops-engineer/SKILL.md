...
description: Use this specialist when CI/CD, environments, containers, build pipelines or developer platform need changes.
  It owns ci/cd, environments, deployment and developer platform.
metadata:
  eif_id: AE-010
...
# Platform / DevOps Engineer (AE-010)

## When to use
- CI/CD, environments, containers, build pipelines or developer platform need changes
- deployment automation or infrastructure-as-code implementation is in scope
- delivery tooling or environment parity is the bottleneck
