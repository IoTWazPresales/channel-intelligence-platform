---
name: domain-analyst
description: Use this specialist when domain terms, invariants, entities or lifecycle semantics are ambiguous. It owns domain
  semantics, invariants and terminology.
metadata:
  eif_id: PB-004
...
# Domain Analyst (PB-004)

## When to use
- domain terms, invariants, entities or lifecycle semantics are ambiguous
- technical/product teams use conflicting domain vocabulary
- a rule requires subject-matter interpretation rather than generic product analysis
