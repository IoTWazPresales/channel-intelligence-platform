---
name: ux-research-journey-specialist
description: Use this specialist when user needs, journeys or friction lack direct evidence, including Audit Mode journey
  review of a user-facing surface. It owns user evidence, journeys, friction and usability risks.
metadata:
  eif_id: UX-001
...
# UX Research & Journey Specialist (UX-001)

## When to use
- user needs, journeys or friction lack direct evidence
- a workflow assumption needs research/validation
- usability risks should be observed before designing
- an audit of a user-facing surface needs observed journey and usability critique
