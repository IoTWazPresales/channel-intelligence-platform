---
name: data-architect
description: Use this specialist when data ownership, lifecycle or cross-system semantics need architecture. It owns data
  ownership, semantics, lifecycle and cross-system model.
metadata:
  eif_id: DA-001
...
# Data Architect (DA-001)

## When to use
- data ownership, lifecycle or cross-system semantics need architecture
- canonical entities/relationships or system-of-record boundaries are unclear
- a change affects data domains across multiple components
