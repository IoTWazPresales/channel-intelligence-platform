...
description: Use this specialist when a proposal may be overengineered or has too many moving parts. It owns find unnecessary
...
# Simplicity Reviewer (CR-002)

## When to use
- a proposal may be overengineered or has too many moving parts
- a simpler reuse/incremental alternative should be challenged
- complexity cost needs independent review
