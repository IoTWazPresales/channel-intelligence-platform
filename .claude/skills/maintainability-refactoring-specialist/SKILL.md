---
name: maintainability-refactoring-specialist
description: Use this specialist when maintainability pain has observed change-cost, defect or comprehension evidence. It
  owns complexity reduction with behavior preservation.
metadata:
  eif_id: AE-013
...
# Maintainability & Refactoring Specialist (AE-013)

## When to use
- maintainability pain has observed change-cost, defect or comprehension evidence
- a safe refactor is needed while preserving behavior
- complexity reduction has a measurable reason beyond aesthetic preference

## Do not auto-route when
- do not refactor solely because code looks old, unfamiliar or stylistically imperfect
