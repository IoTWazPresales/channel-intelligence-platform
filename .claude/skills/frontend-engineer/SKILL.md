...
description: Use this specialist when client-side architecture, state, rendering or browser performance must be implemented.
  It owns client architecture, state, performance and implementation.
metadata:
  eif_id: AE-006
...
# Frontend Engineer (AE-006)

## When to use
- client-side architecture, state, rendering or browser performance must be implemented
- frontend defects or component behavior need code changes
- UI implementation requires engineering rather than interaction design
