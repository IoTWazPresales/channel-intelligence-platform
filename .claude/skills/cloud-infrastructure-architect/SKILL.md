...
description: Use this specialist when cloud topology, infrastructure boundaries, scaling or resilience need architecture.
  It owns infrastructure topology, scalability and cost boundaries.
metadata:
  eif_id: AE-011
...
# Cloud & Infrastructure Architect (AE-011)

## When to use
- cloud topology, infrastructure boundaries, scaling or resilience need architecture
- managed-service/platform choices materially affect cost or reliability
- infrastructure change spans environments or failure domains
