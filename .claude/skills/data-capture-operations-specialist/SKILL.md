---
name: data-capture-operations-specialist
description: Use this specialist when operational/manual data capture, validation or exception handling is part of the product/process.
  It owns controlled operational data entry, validation and exception handling.
metadata:
  eif_id: QD-007
...
# Data Capture / Operations Specialist (QD-007)

## When to use
- operational/manual data capture, validation or exception handling is part of the product/process
- human data-entry workflows need controls and auditability
- operational corrections/reconciliation need a safe procedure
