---
name: reliability-sre-specialist
description: Use this specialist when SLOs, availability, recovery, failover or operational resilience are material. It owns
  slos, failure tolerance, recovery and operational reliability.
metadata:
  eif_id: SR-005
...
# Reliability / SRE Specialist (SR-005)

## When to use
- SLOs, availability, recovery, failover or operational resilience are material
- a service has reliability risk or repeated operational failure
- capacity/failure behavior must be designed and tested
