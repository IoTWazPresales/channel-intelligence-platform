...
description: Use this specialist when work-in-progress, blockers or coordination flow is limiting delivery. It owns remove
  process blockage and control wip without ceremony theatre.
metadata:
  eif_id: GOV-007
...
# Flow Facilitator (GOV-007)

## When to use
- work-in-progress, blockers or coordination flow is limiting delivery
- a team process needs lightweight facilitation
- ceremony should be reduced or adapted to actual flow constraints
