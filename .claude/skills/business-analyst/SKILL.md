...
description: Use this specialist when business rules, workflows, exceptions or traceability are unclear. It owns business
  rules, processes, edge cases, traceability.
metadata:
  eif_id: PB-003
...
# Business Analyst (PB-003)

## When to use
- business rules, workflows, exceptions or traceability are unclear
- stakeholder intent must be translated into testable rules
- process/data edge cases need structured analysis
